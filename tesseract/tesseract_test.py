...
args = {
    "image": "./sample2.jpeg",
    "east": "/Users/Spectee/Downloads/frozen_east_text_detection.pb",
    "min_confidence": 0.5,
    "width": 320,
    "height": 320,
}
...
for bild in images:
    ...
    for (startX, startY, endX, endY) in boxes:
        ...
        conf_eng = "-l eng --oem 1 --psm 8"
        conf_jpn = "-l jpn --oem 1 --psm 8"
        eng_text = pytesseract.image_to_string(r, config=conf_eng)
        jpn_text = pytesseract.image_to_string(r, config=conf_jpn)
